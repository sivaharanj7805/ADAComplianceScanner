...
export const metadata: Metadata = {
  ...
  description:
    'AccessAudit pricing for ADA/WCAG compliance scanning and monitoring. Plans for municipalities ($79/mo), e-commerce ($99/mo), and agencies ($199/mo). Free 14-day trial, no credit card required.',
  openGraph: {
    title: 'ADA Compliance Scanner Pricing | Plans from $79/month',
    description:
...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      'Per-portfolio pricing ($15/extra site)',
