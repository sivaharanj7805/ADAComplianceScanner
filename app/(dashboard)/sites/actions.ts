...
export async function createSiteAction(
  ...
  try {
    ...
    console.error('[createSiteAction] Unexpected error:', err);
...
export async function deleteSiteAction(
  ...
  try {
    ...
    console.error('[deleteSiteAction] Unexpected error:', err);
    return { error: 'Failed to delete site. Please try again.' };
  }
...
export async function triggerScanAction(
  ...
  try {
    ...
    try {
      ...
      return { error: 'Failed to connect to scan service. Please check your connection and try again.' };
    }
  } catch (err) {
    console.error('[triggerScanAction] Unexpected error:', err);
    return { error: 'Something went wrong. Please try again.' };
  }
}
